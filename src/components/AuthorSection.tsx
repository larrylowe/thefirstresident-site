    ...
    <section id="author" className="section-anchor bg-charcoal py-24">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-5 md:grid-cols-[0.8fr_1fr] md:px-8">
        ...
        <FadeIn delay={0.15}>
          ...
          <a href="mailto:partner54digital@gmail.com" className="mt-8 inline-flex rounded-sm border border-antique px-7 py-4 text-sm uppercase tracking-[0.18em] text-parchment transition hover:bg-antique hover:text-charcoal">Contact</a>
        </FadeIn>
      </div>
    </section>
  );
