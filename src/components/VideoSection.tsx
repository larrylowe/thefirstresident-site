...
// Preserve existing video URL; fallback to provided URL if not set
const videoUrl =
  process.env.NEXT_PUBLIC_VIDEO_URL ||
  "https://youtu.be/pOdHt66Bue4";
  ...
  return (
    <section id="video" className="overflow-hidden bg-ink" style={{ scrollMarginTop: "80px" }}>
      <div className="grid grid-cols-1 md:grid-cols-[55fr_45fr]">
        {/* Image / video clickable column */}
        <a
          href={videoUrl}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Watch the video synopsis on YouTube"
          className="group relative block h-[340px] md:h-auto md:min-h-[640px] overflow-hidden"
        >
          <Image
